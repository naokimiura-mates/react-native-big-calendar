...
var isDark = reactNative.Appearance.getColorScheme() === 'dark';
var defaultTheme = {
    isRTL: false,
    palette: {
        primary: {
...
function formatStartEnd(start, end, format) {
    return dayjs__default['default'](start).format(format) + " - " + dayjs__default['default'](end).format(format);
}
...
var _HourGuideColumn = function (_a) {
    ...
    return (React__namespace.createElement(reactNative.View, { style: { height: cellHeight } },
        React__namespace.createElement(reactNative.Text, { style: [textStyle, u['text-center']] }, formatHour(hour, ampm))));
};
...
function _CalendarBody(_a) {
    ...
    var _renderMappedEvent = function (event) { return (React__namespace.createElement(CalendarEvent, { key: "" + event.start + event.title + event.end, event: event, onPressEvent: onPressEvent, eventCellStyle: eventCellStyle, showTime: showTime, eventCount: getCountOfEventsAtEvent(event, events), eventOrder: getOrderOfEvent(event, events), overlapOffset: overlapOffset, renderEvent: renderEvent, ampm: ampm })); };
    var theme = useTheme();
    return (React__namespace.createElement(reactNative.ScrollView, __assign({ style: [
        ...
        React__namespace.createElement(reactNative.View, __assign({ style: [u['flex-1'], theme.isRTL ? u['flex-row-reverse'] : u['flex-row']] }, (reactNative.Platform.OS === 'web' ? panResponder.panHandlers : {})),
            React__namespace.createElement(reactNative.View, { style: [u['z-20'], u['w-50']] }, hours.map(function (hour) { return (React__namespace.createElement(HourGuideColumn, { key: hour, cellHeight: cellHeight, hour: hour, ampm: ampm })); })),
            dateRange.map(function (date) { return (React__namespace.createElement(reactNative.View, { style: [u['flex-1'], u['overflow-hidden']], key: date.toString() },
                hours.map(function (hour) { return (React__namespace.createElement(HourGuideCell, { key: hour, cellHeight: cellHeight, date: date, hour: hour, onPress: _onPressCell })); }),
                events
                    .filter(function (_a) {
                    var start = _a.start;
...
function _CalendarEventForMonthView(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, { style: { minHeight: 22 } }, ((!isMultipleDays && date.isSame(event.start, 'day')) ||
        (isMultipleDays && isMultipleDaysStart)) && (React__namespace.createElement(reactNative.TouchableOpacity, __assign({}, touchableOpacityProps),
...
function _CalendarHeader(_a) {
    ...
    return (React__namespace.createElement(reactNative.View, { style: [
        ...
        dateRange.map(function (date) {
            ...
            return (React__namespace.createElement(reactNative.TouchableOpacity, { style: [u['flex-1'], u['pt-2']], onPress: function () { return _onPress(date.toDate()); }, disabled: onPressDateHeader === undefined, key: date.toString() },
                ...
                React__namespace.createElement(reactNative.View, { style: [
                    ...
                    return (React__namespace.createElement(reactNative.View, { style: [eventCellCss.style, primaryBg, u['mt-2']], key: "" + event.start + event.title },
                        React__namespace.createElement(reactNative.Text, { style: {
...
function _CalendarContainer(_a) {
    ...
    var _r = React__default['default'].useState(dayjs__default['default'](date)), targetDate = _r[0], setTargetDate = _r[1];
    React__default['default'].useEffect(function () {
        if (date) {
    ...
    return (React__default['default'].createElement(React__default['default'].Fragment, null,
        ...
        React__default['default'].createElement(CalendarBody, __assign({}, commonProps, { style: bodyContainerStyle, containerHeight: height, events: daytimeEvents, eventCellStyle: eventCellStyle, hideNowIndicator: hideNowIndicator, overlapOffset: overlapOffset, scrollOffsetMinutes: scrollOffsetMinutes, ampm: ampm, showTime: showTime, onPressCell: onPressCell, onPressEvent: onPressEvent, onSwipeHorizontal: onSwipeHorizontal, renderEvent: renderEvent }))));
}
